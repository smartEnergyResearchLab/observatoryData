...
#  2020-12 SERL Observatory Data Release.
...
source("N:/R/observatoryData/scripts/setup_v2020_12.R")
...
#filename_questions <- "survey_questions.csv" # Don't think we need this
...
#   #questions <- fread(paste(dataDirectory, filename_questions, sep = "")) # Don't think we need this
# }
# 
...
# ---
# Create table for all survey question information - REDUNDANT???
# ---
...
save(survey_reordered, 
     file = paste(survey_location, survey_output_name, ".RData", sep = ""))
