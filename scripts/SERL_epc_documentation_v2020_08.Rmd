...
if(load_epc == TRUE) {
  ...
  save(epc,
       file = paste(location_processed, epc_output_name, ".RData", sep = ""))
} else {
  load(paste(location_processed, epc_output_name, ".RData", sep = ""))
}
...
save(nrow_epc,
     ncol_epc,
     file = paste(location_RData, epc_stats_file, sep = "")
)
