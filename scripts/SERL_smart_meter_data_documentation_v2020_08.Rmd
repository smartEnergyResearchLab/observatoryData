...
info_tab <- create.info.table(creation_date = "2020-08-28")
```
...
- **SERL_smart_meter_rt_summary_{version}.csv**: data quality summary for each read type for each participant (such as number of errors found by type) and basic read statistics (such as mean and maximum)
