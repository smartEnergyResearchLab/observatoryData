---
title: "Smart meter consumption data: Data quality report"
...
fig_caps(name = "daily_over_time", 
         caption = "For daily reads: number of participants in the SERL Observatory with at least 95% of data available and valid, by month.")

fig_caps(name = "hh_im_over_time", 
         caption = "For half-hourly import reads: number of participants in the SERL Observatory with at least 95% of data available and valid, by month.")

fig_caps(name = "hh_ex_over_time", 
         caption = "For half-hourly export reads: number of participants in the SERL Observatory with at least 95% of data available and valid, by month.")
...
```{r fig.width = fig.w * 0.7, fig.height = fig.h, fig.fullwidth = fullwidth, echo = FALSE, message = FALSE, warning = FALSE}
daily_over_time
```
...
if(load_table_data == FALSE) {
  ...
  # Elec
  # f.hh.elec <- ggplot(hh[Elec_act_imp_flag == 1], aes(Elec_act_imp_hh_Wh)) + 
  # geom_histogram(aes(y = ..density..), binwidth = 50) + 
  # labs(x = "Valid half-hourly electricity active import readings (Wh)") +
  # theme(text = element_text(size = font.size))
  # fig_caps(name = "f.hh.elec", 
  #          caption = "Histogram of half-hourly electricity active import readings, excluding those flagged as errors. Full range shown, bin width = 50 Wh.")
...
```{r fig.width = fig.w * 0.8, fig.height = fig.h, fig.fullwidth = fullwidth, echo = FALSE, message = FALSE, warning = FALSE}
